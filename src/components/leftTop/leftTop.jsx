            ...
            <aside className={"leftPart"}>
                ...
                <div className={"catch-part"}>
                    <svg className={"svg_part"}width="898" height="28" viewBox="0 0 898 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line y1="1" x2="896" y2="1" stroke="black" strokeWidth="2"/>
                        <line x1="1" y1="2" x2="0.999999" y2="28" stroke="black" strokeWidth="2"/>
                        <line x1="897" y1="5.83469e-08" x2="897" y2="26" stroke="black" strokeWidth="2"/>
                    </svg>
                    ...
                    <svg width="988" height="71" viewBox="0 0 988 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line x1="168" y1="35.9999" x2="2" y2="35.9999" stroke="black" strokeWidth="2"/>
                        <line x1="988" y1="35.9999" x2="273" y2="35.9998" stroke="black" strokeWidth="2"/>
                        <line x1="987" y1="34.9999" x2="987" y2="8.99994" stroke="black" strokeWidth="2"/>
                        <line x1="1" y1="37" x2="1" y2="11" stroke="black" strokeWidth="2"/>
